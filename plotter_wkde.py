...
with open('./sig_psi_E_8yr_fit_IC86_2012_16_MC.pkl', 'rb') as ifile:
...
with open('./sig_E_8yr_fit_IC86_2012_16_MC.pkl', 'rb') as ifile:
...
mc = np.load('../../dataset_8yr_fit_IC86_2015_16_mc_2017_11_21_append.npy')
...
def make_plot(logE, sigma_p, delta_sigma=0.2, show_quantile=False):
    ...
    plt.savefig("./pdf/wkde_cpd_rayleigh_lE_%.1f_sigma_%.2f.pdf" %(logE, sigma_p))
    plt.clf()
'''    
make_plot(2.0, 0.2) 
make_plot(2.0, 0.5)
